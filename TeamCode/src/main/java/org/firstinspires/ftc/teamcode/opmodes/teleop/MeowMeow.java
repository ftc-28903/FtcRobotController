...
@TeleOp(name = "meowmeow")
public class MeowMeow extends NextFTCOpMode {
    public MeowMeow() {
        addComponents(
    ...
    private final MotorEx intake1 = new MotorEx("intake1").reversed();
    ...
    public void onUpdate() {
        ...
        ActiveOpMode.telemetry().addData("shooter1 power", shooter1.getPower());
        ...
        RobotLog.d("Motor Amp: Shooter Motor 1: " + shooter1.getMotor().getCurrent(CurrentUnit.AMPS));
        RobotLog.d("Motor Amp: Shooter Motor 2: " + shooter2.getMotor().getCurrent(CurrentUnit.AMPS));
